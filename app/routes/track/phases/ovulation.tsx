...
export default function Ovulation() {
    return (
      <div className="pt-16 px-8 relative items-center">
        ...
        A sudden increase in another hormone — <a target="_blank" href="https://my.clevelandclinic.org/health/body/22255-luteinizing-hormone">luteinizing hormone (LH)</a> — causes your ovary to release its egg. This event is ovulation.
        </p>
