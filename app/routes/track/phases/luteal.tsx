...
export default function Luteal() {
    return (
      <div className="pt-16 px-8 relative items-center">
        ...
        <h4 className="mb-0" style={{textAlign:"center"}}><b>Luteal Phase</b></h4>
        <p className="text-sm pt-5 text-justify">
          ...
          If the egg becomes fertilized by sperm and attaches itself to your uterine wall (implantation), you become pregnant. 
