...
export default [
    ...
    route("track/phases/menstrual", "routes/track/phases/menstrual.tsx"),
    route("track/phases/follicular", "routes/track/phases/follicular.tsx"),
    route("track/phases/luteal", "routes/track/phases/luteal.tsx"),
    route("track/phases/ovulation", "routes/track/phases/ovulation.tsx"),
